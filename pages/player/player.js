...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({height: app.globalData.statusBarHeight,backgroundAudioManager})
  ...
  listenBackgroundAudioManager() {
    ...
    backgroundAudioManager.onTimeUpdate(() => {
      this.setData({
        processNum: (backgroundAudioManager.currentTime/backgroundAudioManager.duration).toFixed(3)*100,
        currentTime: this.formatSecond(backgroundAudioManager.currentTime),
        totalTime: this.formatSecond(backgroundAudioManager.duration)
      })
